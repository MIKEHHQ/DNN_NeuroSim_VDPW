...
def Depthwise(in_planes, stride=1, groups=3, dilation=1,padding=1, args=None, logger=None):
    ...
    if args.mode == "WAGE":
        ...
        conv2d = FConv2d(in_planes, in_planes, kernel_size=3, stride=stride,
...
class MobileNet(nn.Module):
    ...
    def __init__(self,block, num_classes, args, logger):
        ...
        self.conv1 = Conv2d(3, 32, kernel_size=3, stride=1, padding=1, args=args, logger=logger) # change stride from 1 to 2
