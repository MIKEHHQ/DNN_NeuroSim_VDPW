...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv1 = conv1x1(inplanes, width,args=args,logger=logger) # pointwise
        self.bn1 = norm_layer(width)
        self.conv2 = conv3x3(width, width, stride, groups, dilation,args=args,logger=logger) # depthwise: groups=inplanes
